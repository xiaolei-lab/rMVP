...
##############################################################################################
version <- "0.1"
authors <- "Lilin Yin, Zhiwu Zhang, Xinyun Li, Shuhong Zhao, and Xiaolei Liu"
...
cat(paste("#   ", "Version: ", version, paste(rep(" ", 72-nchar(version)), collapse=""), "#", sep=""), "\n")
cat(paste("#  ", "Authors:", authors, paste(rep(" ", 70-nchar(authors)), collapse=""),"#", "\n"))
cat(paste("#  ", "Contact: xiaoleiliu@mail.hzau.edu.cn", paste(rep(" ", 43), collapse=""), "#", "\n"))
cat(paste("#",  paste(rep("-", 84), collapse=""), "#", sep=""), "\n")
}
