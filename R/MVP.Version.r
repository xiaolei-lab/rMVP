...
cat(paste("#   ", "Version: ", version, paste(rep(" ", 67), collapse=""), "#", sep=""), "\n")
cat(paste("#  ", "Authors: Lilin Yin, Zhiwu Zhang, Xinyun Li, Shuhong Zhao, and Xiaolei Liu", paste(rep(" ", 31), collapse=""),"#", "\n"))
